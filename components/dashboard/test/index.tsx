            ...
            <div className="flex-1 w-full h-full rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 flex flex-col items-center justify-center p-12 space-y-6">
              ...
              <div className="space-y-4 text-center max-w-xl">
                ...
                <div className="mt-6 grid grid-cols-2 gap-8 border-t border-zinc-100 dark:border-zinc-800 pt-8">
                  <div className="space-y-4 p-6 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:border-indigo-500 dark:hover:border-indigo-500 transition-colors duration-200 cursor-pointer bg-white dark:bg-zinc-900 shadow-sm hover:shadow-md">
                    <div className="flex items-center space-x-3">
                      <h4 className="text-base font-medium text-indigo-600 dark:text-indigo-400">Practice Mode</h4>
                  ...
                  <div className="space-y-4 p-6 rounded-lg border border-zinc-200 dark:border-zinc-700 hover:border-indigo-500 dark:hover:border-indigo-500 transition-colors duration-200 cursor-pointer bg-white dark:bg-zinc-900 shadow-sm hover:shadow-md">
                    <div className="flex items-center space-x-3">
                      <h4 className="text-base font-medium text-zinc-900 dark:text-zinc-100">Exam Mode</h4>
