            ...
            <div className="relative min-h-screen w-full flex flex-col items-center justify-center snap-start shrink-0">
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="flex flex-col items-center justify-center text-2xl font-bold text-white">
                  ...
                  <h4 className="mb-5 w-[600px] rounded-xl bg-white/5 backdrop-blur-sm p-6 text-center text-2xl font-bold border border-white/10">
                    <div className="flex flex-wrap items-center justify-center gap-3">
                      <span>"Forget the grammar police —</span>
                      <LanguageScroll />
                      <span>writing is safe here."</span>
                    </div>
                  </h4>
                  <div className="flex items-center justify-center gap-2 text-lg font-medium text-white/80">
                    ...
                    <TypewriterText
                      text="Practice essays that won't leave your brain needing a rescue mission"
                      delay={60}
                    />
                  </div>
                </div>
